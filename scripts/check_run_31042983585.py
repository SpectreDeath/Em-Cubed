...
url = 'https://api.github.com/repos/SpectreDeath/Em-Cubed/actions/runs/31042983585/jobs'
...
try:
    with urllib.request.urlopen(req) as resp:
        ...
        for j in data['jobs']:
            print(f"Job ID: {j['id']} | Name: {j['name']} | Status: {j['status']} | Conclusion: {j['conclusion']}")
