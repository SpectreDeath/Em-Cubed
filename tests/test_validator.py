...
class TestValidationResult:
    ...
    def test_result_creation(self):
        ...
        result = ValidationResult(
            skill_id="test/skill", valid=True, issues=[], quality_score=0.95, validated_at="2023-01-01T00:00:00"
        )
    ...
    def test_add_issue_no_error(self):
        ...
        result = ValidationResult(skill_id="test/skill", valid=True, issues=[], quality_score=0.0, validated_at="")

        # Add a warning
        result.add_issue(
            severity=ValidationSeverity.WARNING, code="TEST_WARNING", message="Test warning", component="test"
        )
    ...
    def test_add_issue_with_error(self):
        ...
        # Add an error
        result.add_issue(severity=ValidationSeverity.ERROR, code="TEST_ERROR", message="Test error", component="test")
    ...
    def test_to_dict(self):
        ...
        result = ValidationResult(
            skill_id="test/skill", valid=False, issues=[], quality_score=0.6, validated_at="2023-01-01T00:00:00"
        )
