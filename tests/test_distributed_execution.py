...
def test_submit_workflow():
    ...
    # Create test tasks
    task1 = DistributedTask(workflow_id="test-workflow", skill_id="skill-1", input_data={"param": "value"})

    task2 = DistributedTask(
        workflow_id="test-workflow", skill_id="skill-2", input_data={"param": "value2"}, dependencies=[task1.task_id]
    )
...
def test_get_task_status():
    ...
    task = DistributedTask(workflow_id="test-workflow", skill_id="test-skill", input_data={})
...
def test_get_workflow_status():
    ...
    # Create tasks
    task1 = DistributedTask(workflow_id="test-workflow", skill_id="skill-1", input_data={})

    task2 = DistributedTask(workflow_id="test-workflow", skill_id="skill-2", input_data={})
...
def test_task_serialization():
    ...
    original_task = DistributedTask(
        workflow_id="test-workflow", skill_id="test-skill", input_data={"key": "value"}, dependencies=["dep1", "dep2"]
    )
...
""")
    ...
    task1 = DistributedTask(
        workflow_id="dist-workflow", skill_id="Mathematics/Adder Skill", input_data={"a": 12, "b": 8}
    )
