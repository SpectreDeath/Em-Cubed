"""Tests for graph-neural-network skill."""
...
SKILL_FILE = Path(Path(__file__).parent.parent.parent / "skills" / "GRAPH_ML" / "graph-neural-network" / "SKILL.md")
SKILL_ID = "GRAPH_ML/graph-neural-network"
...
class Testgraph_neural_networkSkill:
    """Test suite for graph-neural-network."""
    ...
    def test_metadata_valid(self):
        ...
        assert metadata_dict["name"] == "graph-neural-network"
        assert metadata_dict["domain"] == "GRAPH_ML"
