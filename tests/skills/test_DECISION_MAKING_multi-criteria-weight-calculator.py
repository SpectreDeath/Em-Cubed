"""Tests for multi-criteria-weight-calculator skill."""
...
SKILL_FILE = Path(Path(__file__).parent.parent.parent / "skills" / "DECISION_MAKING" / "multi-criteria-weight-calculator" / "SKILL.md")
SKILL_ID = "DECISION_MAKING/multi-criteria-weight-calculator"
...
class Testmulti_criteria_weight_calculatorSkill:
    """Test suite for multi-criteria-weight-calculator."""
    ...
    def test_metadata_valid(self):
        ...
        assert metadata_dict["name"] == "multi-criteria-weight-calculator"
        assert metadata_dict["domain"] == "DECISION_MAKING"
