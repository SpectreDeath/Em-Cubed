"""Tests for prompt-quality-evaluator skill."""
...
SKILL_FILE = Path("D:/GitHub/projects/em-cubed/.agents/skills/prompt-quality-evaluator/SKILL.md")
...
class Testprompt_quality_evaluatorSkill:
    """Test suite for prompt-quality-evaluator."""
    ...
    def test_metadata_valid(self):
        ...
        assert metadata_dict["name"] == "prompt-quality-evaluator"
        assert metadata_dict["domain"] == "META_SKILLS"
