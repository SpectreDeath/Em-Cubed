"""Tests for resource-allocation-planner skill."""
...
SKILL_FILE = Path(Path(__file__).parent.parent.parent / "skills" / "RESOURCE_MANAGEMENT" / "resource-allocation-planner" / "SKILL.md")
SKILL_ID = "RESOURCE_MANAGEMENT/resource-allocation-planner"
...
class Testresource_allocation_plannerSkill:
    """Test suite for resource-allocation-planner."""
    ...
    def test_metadata_valid(self):
        ...
        assert metadata_dict["name"] == "resource-allocation-planner"
        assert metadata_dict["domain"] == "RESOURCE_MANAGEMENT"
