"""Tests for data-pipeline-orchestrator skill."""
...
SKILL_FILE = Path(Path(__file__).parent.parent.parent / "skills" / "DATA_PROCESSING" / "data-pipeline-orchestrator" / "SKILL.md")
SKILL_ID = "DATA_PROCESSING/data-pipeline-orchestrator"
...
class Testdata_pipeline_orchestratorSkill:
    """Test suite for data-pipeline-orchestrator."""
    ...
    def test_metadata_valid(self):
        ...
        assert metadata_dict["name"] == "data-pipeline-orchestrator"
        assert metadata_dict["domain"] == "DATA_PROCESSING"
