"""Tests for recommendation-engine skill."""
...
SKILL_FILE = Path(Path(__file__).parent.parent.parent / "skills" / "RECOMMENDER_SYSTEMS" / "recommendation-engine" / "SKILL.md")
SKILL_ID = "RECOMMENDER_SYSTEMS/recommendation-engine"
...
class Testrecommendation_engineSkill:
    ...
    def test_metadata_valid(self):
        ...
        assert metadata_dict["name"] == "recommendation-engine"
        assert metadata_dict["domain"] == "RECOMMENDER_SYSTEMS"
