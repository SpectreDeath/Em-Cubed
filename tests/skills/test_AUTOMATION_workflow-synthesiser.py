"""Tests for workflow-synthesiser skill."""
...
SKILL_FILE = Path(Path(__file__).parent.parent.parent / "skills" / "AUTOMATION" / "workflow-synthesiser" / "SKILL.md")
...
class Testworkflow_synthesiserSkill:
    """Test suite for workflow-synthesiser."""
    ...
    def test_metadata_valid(self):
        ...
        assert metadata_dict["name"] == "workflow-synthesiser"
        assert metadata_dict["domain"] == "AUTOMATION"
