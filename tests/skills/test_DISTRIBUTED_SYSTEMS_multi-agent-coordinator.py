"""Tests for multi-agent-coordinator skill."""
...
SKILL_FILE = Path(
    Path(__file__).parent.parent.parent / "skills" / "DISTRIBUTED_SYSTEMS" / "multi-agent-coordinator" / "SKILL.md"
)
...
class Testmulti_agent_coordinatorSkill:
    ...
    def test_metadata_valid(self):
        ...
        assert metadata_dict["name"] == "multi-agent-coordinator"
        assert metadata_dict["domain"] == "DISTRIBUTED_SYSTEMS"
