"""Tests for knowledge-graph-builder skill."""
...
SKILL_FILE = Path(Path(__file__).parent.parent.parent / "skills" / "KNOWLEDGE_GRAPH" / "knowledge-graph-builder" / "SKILL.md")
SKILL_ID = "KNOWLEDGE_GRAPH/knowledge-graph-builder"
...
class Testknowledge_graph_builderSkill:
    ...
    def test_metadata_valid(self):
        ...
        assert metadata_dict["name"] == "knowledge-graph-builder"
        assert metadata_dict["domain"] == "KNOWLEDGE_GRAPH"
