"""Tests for pathfinding-with-constraints skill."""
...
SKILL_FILE = Path(Path(__file__).parent.parent.parent / "skills" / "OPTIMIZATION" / "pathfinding-with-constraints" / "SKILL.md")
...
class Testpathfinding_with_constraintsSkill:
    """Test suite for pathfinding-with-constraints."""
    ...
    def test_metadata_valid(self):
        ...
        assert metadata_dict["name"] == "pathfinding-with-constraints"
