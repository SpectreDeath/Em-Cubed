"""Tests for feature-engineering-pipeline skill."""
...
SKILL_FILE = Path(Path(__file__).parent.parent.parent / "skills" / "FEATURE_ENGINEERING" / "feature-engineering-pipeline" / "SKILL.md")
SKILL_ID = "FEATURE_ENGINEERING/feature-engineering-pipeline"
...
class Testfeature_engineering_pipelineSkill:
    ...
    def test_metadata_valid(self):
        ...
        assert metadata_dict["name"] == "feature-engineering-pipeline"
        assert metadata_dict["domain"] == "FEATURE_ENGINEERING"
