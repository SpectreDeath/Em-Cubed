"""Tests for multi-surface-decision-tree skill."""
...
SKILL_FILE = Path(Path(__file__).parent.parent.parent / "skills" / "DECISION_MAKING" / "multi-surface-decision-tree" / "SKILL.md")
...
class Testmulti_surface_decision_treeSkill:
    """Test suite for multi-surface-decision-tree."""
    ...
    def test_metadata_valid(self):
        ...
        assert metadata_dict["name"] == "multi-surface-decision-tree"
