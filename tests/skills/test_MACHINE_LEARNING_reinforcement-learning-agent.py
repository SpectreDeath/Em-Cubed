"""Tests for reinforcement-learning-agent skill."""
...
SKILL_FILE = Path(Path(__file__).parent.parent.parent / "skills" / "MACHINE_LEARNING" / "reinforcement-learning-agent" / "SKILL.md")
SKILL_ID = "MACHINE_LEARNING/reinforcement-learning-agent"
...
class Testreinforcement_learning_agentSkill:
    ...
    def test_metadata_valid(self):
        ...
        assert metadata_dict["name"] == "reinforcement-learning-agent"
        assert metadata_dict["domain"] == "MACHINE_LEARNING"
