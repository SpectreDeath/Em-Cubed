"""Tests for sentiment-intelligence-engine skill."""
...
SKILL_FILE = Path(Path(__file__).parent.parent.parent / "skills" / "NLP" / "sentiment-intelligence-engine" / "SKILL.md")
...
class Testsentiment_intelligence_engineSkill:
    """Test suite for sentiment-intelligence-engine."""
    ...
    def test_metadata_valid(self):
        ...
        assert metadata_dict["name"] == "sentiment-intelligence-engine"
        assert metadata_dict["domain"] == "NLP"
