"""Tests for constraint-satisfaction-solver skill."""
...
SKILL_FILE = Path(Path(__file__).parent.parent.parent / "skills" / "OPTIMIZATION" / "constraint-satisfaction-solver" / "SKILL.md")
SKILL_ID = "OPTIMIZATION/constraint-satisfaction-solver"
...
class Testconstraint_satisfaction_solverSkill:
    """Test suite for constraint-satisfaction-solver."""
    ...
    def test_metadata_valid(self):
        ...
        assert metadata_dict["name"] == "constraint-satisfaction-solver"
