"""Tests for anomaly-detection-system skill."""
...
SKILL_FILE = Path(Path(__file__).parent.parent.parent / "skills" / "ML_OPERATIONS" / "anomaly-detection-system" / "SKILL.md")
SKILL_ID = "ML_OPERATIONS/anomaly-detection-system"
...
class Testanomaly_detection_systemSkill:
    ...
    def test_metadata_valid(self):
        ...
        assert metadata_dict["name"] == "anomaly-detection-system"
        assert metadata_dict["domain"] == "ML_OPERATIONS"
