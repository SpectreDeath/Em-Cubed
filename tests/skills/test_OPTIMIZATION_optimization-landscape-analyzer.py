"""Tests for optimization-landscape-analyzer skill."""
...
SKILL_FILE = Path(Path(__file__).parent.parent.parent / "skills" / "OPTIMIZATION" / "optimization-landscape-analyzer" / "SKILL.md")
SKILL_ID = "OPTIMIZATION/optimization-landscape-analyzer"
...
class Testoptimization_landscape_analyzerSkill:
    """Test suite for optimization-landscape-analyzer."""
    ...
    def test_metadata_valid(self):
        ...
        assert metadata_dict["name"] == "optimization-landscape-analyzer"
