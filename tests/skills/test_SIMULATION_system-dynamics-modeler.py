"""Tests for system-dynamics-modeler skill."""
...
SKILL_FILE = Path(Path(__file__).parent.parent.parent / "skills" / "SIMULATION" / "system-dynamics-modeler" / "SKILL.md")
SKILL_ID = "SIMULATION/system-dynamics-modeler"
...
class Testsystem_dynamics_modelerSkill:
    """Test suite for system-dynamics-modeler."""
    ...
    def test_metadata_valid(self):
        ...
        assert metadata_dict["name"] == "system-dynamics-modeler"
        assert metadata_dict["domain"] == "SIMULATION"
