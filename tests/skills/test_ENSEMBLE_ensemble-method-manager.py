"""Tests for ensemble-method-manager skill."""
...
SKILL_FILE = Path(Path(__file__).parent.parent.parent / "skills" / "ENSEMBLE" / "ensemble-method-manager" / "SKILL.md")
SKILL_ID = "ENSEMBLE/ensemble-method-manager"
...
class Testensemble_method_managerSkill:
    """Test suite for ensemble-method-manager."""
    ...
    def test_metadata_valid(self):
        ...
        assert metadata_dict["name"] == "ensemble-method-manager"
        assert metadata_dict["domain"] == "ENSEMBLE"
