"""Tests for time-series-forecaster skill."""
...
SKILL_FILE = Path(Path(__file__).parent.parent.parent / "skills" / "TIME_SERIES" / "time-series-forecaster" / "SKILL.md")
SKILL_ID = "TIME_SERIES/time-series-forecaster"
...
class Testtime_series_forecasterSkill:
    """Test suite for time-series-forecaster."""
    ...
    def test_metadata_valid(self):
        ...
        assert metadata_dict["name"] == "time-series-forecaster"
        assert metadata_dict["domain"] == "TIME_SERIES"
