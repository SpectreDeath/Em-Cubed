"""Tests for stochastic-diffusion-search skill."""
...
class TestSDSOptimizerSkill:
    """Test suite for stochastic-diffusion-search."""
    ...
    def test_metadata_valid(self):
        ...
        assert metadata_dict["name"] == "stochastic-diffusion-search"
