"""Tests for cma-es-optimizer skill."""
...
SKILL_FILE = Path(Path(__file__).parent.parent.parent / "skills" / "OPTIMIZATION" / "cma-es-optimizer" / "SKILL.md")
SKILL_ID = "OPTIMIZATION/cma-es-optimizer"
...
class TestCMAESOptimizerSkill:
    ...
    def test_metadata_valid(self):
        ...
        assert metadata_dict["name"] == "cma-es-optimizer"
