...
| **`ontological-os-cli-suite`** | `skills/ONTOLOGY/ontological-os-cli-suite/` | CLI | End-to-end terminal suite (`em-cubed ontology` validate/elicit/truthmaker/induce/visualize/migrate/export/prove/tui/mcp/health). |
