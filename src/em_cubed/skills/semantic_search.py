...
class SemanticSkillSearch:
    ...
    def _initialize_model(self):
        ...
        try:
            ...
            self.logger.error("Failed to load sentence transformer model", model=self.model_name, error=str(e))
            self.model = None
    ...
    def _load_cached_embeddings(self) -> bool:
        ...
        try:
            ...
            self.logger.info("Loaded skill embeddings from cache", count=len(self._skill_embeddings))
            return True
        except Exception as e:
    ...
    def _save_cached_embeddings(self):
        ...
        try:
            ...
            self.logger.info("Saved skill embeddings to cache", count=len(self._skill_embeddings))
        except Exception as e:
    ...
    def _reindex_all_skills(self):
        ...
        try:
            ...
            for i, skill_id in enumerate(skill_ids):
                ...
                self._last_indexed[skill_id] = self._get_skill_timestamp(self.registry._skills[skill_id])

            # Save to cache
            self._save_cached_embeddings()

            self.logger.info("Completed skill reindexing", count=len(self._skill_embeddings))
        except Exception as e:
